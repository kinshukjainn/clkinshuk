...
const AnimatedCard: React.FC<{ section: SetupSection; index: number }> = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-white/20 via-white/5 to-transparent rounded-md blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

      <div className="relative bg-white/5 border border-white/10 rounded-md p-8 h-full flex flex-col backdrop-blur-sm hover:bg-white/10 transition-all duration-300">
        {/* Icon with gradient background */}
        <div className="mb-6 inline-flex">
          <div className="p-4 bg-gradient-to-br from-emerald-500/20 to-emerald-600/10 rounded-md border border-emerald-500/20 group-hover:border-emerald-500/40 transition-colors duration-300">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-2">
            <div className="h-1 w-12 bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-md" />
  ...
  return (
    <>
      <main className="min-h-screen bg-gradient-to-br from-zinc-950 via-neutral-950 pt-15 to-black text-white relative overflow-hidden">
        ...
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-emerald-500/10 rounded-md blur-3xl animate-pulse" />
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-blue-500/10 rounded-md blur-3xl animate-pulse delay-1000" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32 relative z-10">
          ...
          >
            {/* Badge */}
            <motion.div
              className="inline-flex items-center gap-2 px-4 py-2 bg-white/5 shadow-md shadow-emerald-500 border-2 border-emerald-500 rounded-md mb-8 backdrop-blur-sm"
          ...
          >
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 max-w-4xl mx-auto">
              <motion.div
                className="text-center p-6 bg-white/5 border border-white/10 rounded-md backdrop-blur-sm hover:bg-white/10 transition-all duration-300"
                whileHover={{ y: -4 }}
              >
              ...
              <motion.div
                className="text-center p-6 bg-white/5 border border-white/10 rounded-md backdrop-blur-sm hover:bg-white/10 transition-all duration-300 col-span-2"
                whileHover={{ y: -4 }}
              >
                <div className="text-4xl font-bold bg-gradient-to-br from-emerald-400 to-emerald-600 bg-clip-text text-transparent mb-2">
                  2025
