...
const AnimatedCard: React.FC<{ section: SetupSection }> = ({ section }) => {
  ...
  return (
    <motion.div
      ...
      className="  text-neutral-100  rounded-sm p-4 h-full flex flex-col cursor-pointer"
    >
      {/* Section Header */}
      <div className="flex items-center gap-4 mb-6">
        <div className="p-4 bg-[#303030] rounded-sm ">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
        ...
        >
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 max-w-2xl mx-auto">
            <div className="  rounded-sm p-2 text-center">
            ...
            <div className="  rounded-sm p-2 text-center col-span-2">
              <div className="text-2xl font-normal text-white ">
                2025
              </div>
              <div className="text-sm text-white uppercase tracking-wider mt-1">
