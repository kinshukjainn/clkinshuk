    ...
    <div className="min-h-screen bg-gradient-to-br from-zinc-950 via-black to-zinc-900 px-4 py-6 pt-40 sm:px-6 md:px-8 lg:px-10">
      <main className="w-full max-w-7xl mx-auto space-y-8">
        ...
        <header className="space-y-4 border-b border-white/10 pb-6">
          ...
          {/* Filters Panel */}
          {showFilters && (
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 space-y-3 animate-fadeIn">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <label className="flex items-center gap-2 px-3 py-2 bg-white/5 border border-white/10 rounded-lg text-sm text-gray-300 cursor-pointer hover:bg-white/10">
                  <input
                    type="checkbox"
        ...
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {Object.entries(AUDIT_DATA.coreWebVitals).map(([key, vital]) => (
              <div
                key={key}
                className={`border rounded-xl p-5 hover:scale-105 transition-transform ${getVitalStatusColor(
                  vital.status
                )}`}
              >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap gap-3">
                      {item.estimatedSavingsMs && (
                        <span className="inline-flex items-center gap-2 px-3 py-1 bg-white/5 border border-white/10 rounded-full text-xs text-gray-400">
        ...
        >
          <div className="bg-gradient-to-br from-emerald-500/10 to-green-500/10 border border-emerald-500/20 rounded-xl p-5 mb-5">
        ...
        >
          ...
          {AUDIT_DATA.bestPractices.notes.length > 0 && (
            <div className="mt-5 bg-yellow-500/5 border border-yellow-500/20 rounded-xl p-5">
              <div className="flex items-start gap-4">
        ...
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-gradient-to-br from-yellow-500/10 to-orange-500/10 border border-yellow-500/20 rounded-xl p-5 hover:scale-105 transition-transform">
            ...
            <div className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-purple-500/20 rounded-xl p-5 hover:scale-105 transition-transform">
              <div className="flex items-center gap-3 mb-4">
