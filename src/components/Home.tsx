...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#18181b] text-white  pt-12 sm:pt-16 md:pt-20">
          ...
          <div className="space-y-6 sm:space-y-8">
            {CONFIG.projects.map((project) => (
              <div key={project.title} className="border-2 bg-[#222223] rounded-lg border-[#FFB86C] p-4 sm:p-6">
                ...
                <div className="mb-4">
                  <div className="text-xs sm:text-sm mb-2 text-gray-400">TECH_STACK:</div>
                  <div className="flex flex-wrap gap-2">
                    {project.technologies.map((tech) => (
                      <span key={tech} className="border border-[#FFB86C] rounded-md px-2 py-1 text-xs">
                        {tech}
                      </span>
                    ))}
                  </div>
                ...
                {project.dockerCommand !== "Image is not available" && (
                  <div className="bg-[#181818] border-2 border-[#FFB86C] p-3 mb-4 overflow-x-auto">
                    <div className="flex items-center justify-between gap-2">
                      <code className="text-xs sm:text-sm whitespace-nowrap">{project.dockerCommand}</code>
                ...
                <div className="mb-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {cert.skills.map((skill) => (
                      <span key={skill} className="border border-[#FFB86C] rounded-sm px-2 py-1 text-xs">
                        {skill}
                      </span>
                    ))}
                  </div>
